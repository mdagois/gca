...
serial_multibytes_timer_sources = $(wildcard samples/serial_multibytes_timer/*.rgbasm)
...
serial_parent_child_sources = $(wildcard samples/serial_parent_child/*.rgbasm)
...
serial_switch_roles_sources = $(wildcard samples/serial_switch_roles/*.rgbasm)
...
serial_transfer_sources = $(wildcard samples/serial_transfer/*.rgbasm)
...
sgb_color_transfer_index_sources = $(wildcard samples/sgb_color_transfer_index/*.rgbasm)
